...
with open("src/app/dashboard/teacher/leaderboard/page.tsx", "r", encoding="utf-8") as f:
    content = f.read()
...
with open("src/app/dashboard/teacher/leaderboard/page.tsx", "w", encoding="utf-8") as f:
    f.write(content)
